...
function story1(boy='헨젤', girl='그레텔', mapData){//함수생성
    let person = [boy, girl];
...
story1(undefined, undefined,'빵 부스러기'); //함수호출(매개변수 값 대입)

//동화2.story2 함수 생성, 매개변수 달라지는ㄴ 데이터 기준으로 추가 생성(이름은 자유)\
//나무꾼은 금 도끼를 잃어버렸습니다.
//나무꾼은 쇠 도끼를 잃어버렸습니다.
...
story2(undefined, '금'); //앞의 매개변수 정의 안되어서 기본갑, 뒤 문자만 매개 변수 대입
