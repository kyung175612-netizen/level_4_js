...
//for의 초기값은 처음에 단 한번만 인식하고 다신 인식 안함.
//조건식이 참이면->명령을 수행하고->증감식처리->조건식 반복
//조건식이 거짓이면->명령 수앻하지 않고 for은 강제 종료
...
console.log('----------------------------');
//탄생석 12월~1월 출력
const jewelry = ['가넷','자수정','아쿠아마린','다이아몬드','애매랄드','진주','루비','페리도트','사파이어','오펄','토파즈','터키석'];

for(let i=12; i>0; i--){
    console.log(`${i}월의 탄생석은 ${jewelry[i-1]}입니다.`)
}
